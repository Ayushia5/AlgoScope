...
export const Navbar = () => {
  ...
  return (
    <header className="theme-navbar sticky top-4 z-50 mx-4 rounded-2xl backdrop-blur-xl bg-neutral-950/70 border border-neutral-800/60 shadow-xl shadow-neutral-800/50 ring-1 ring-neutral-700/50">
